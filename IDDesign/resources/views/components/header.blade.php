<header class="grid grid-cols-12 bg-black items-center">
    ...
    <nav class="grid grid-cols-1 sm:grid-rows-2 md:grid-cols-2 md:grid-rows-1 items-center gap-1 text-white col-span-6 md:col-span-4">
        <a href="#for" class="justify-self-end font-bold border rounded-3xl m-2 py-2 px-5">Formulár</a>
        <a href="#con" class="justify-self-end md:justify-self-start font-bold bg-white text-black rounded-3xl m-2 py-2 px-5">Kontakt</a>
    </nav>
</header>
